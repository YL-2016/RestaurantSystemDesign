...
public class ConstUtils {
	...
	// Database
	public final static String INGREDIENT_FILE_PATH = "OrderManagementSystem/database/ingredient";
	public final static String ORDER_FILE_PATH = "OrderManagementSystem/database/order";
	// Log
